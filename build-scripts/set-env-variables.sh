...
export KUBE_ARCH
export ETCD_VERSION="${ETCD_VERSION:-v3.4.21}"
...
# Tag 1.5.13
export CONTAINERD_COMMIT="${CONTAINERD_COMMIT:-a17ec496a95e55601607ca50828147e8ccaeebf1}"
# Release v1.0.3
...
export ADDONS_REPOS="
core,${CORE_ADDONS_REPO:-https://github.com/canonical/microk8s-core-addons},${CORE_ADDONS_REPO_BRANCH:-1.24}
community,${COMMUNITY_ADDONS_REPO:-https://github.com/canonical/microk8s-community-addons},${COMMUNITY_ADDONS_REPO_BRANCH:-1.24}
"
...
export CLUSTER_AGENT_TAG="${CLUSTER_AGENT_TAG:-1.24}"
...
echo "CLUSTER_AGENT_REPO=${CLUSTER_AGENT_REPO}"
echo "CLUSTER_AGENT_TAG=${CLUSTER_AGENT_TAG}"
