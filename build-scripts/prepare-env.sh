...
export ISTIO_VERSION="${ISTIO_VERSION:-v1.2.2}"
export KNATIVE_SERVING_VERSION="${KNATIVE_SERVING_VERSION:-v0.6.0}"
export KNATIVE_BUILD_VERSION="${KNATIVE_BUILD_VERSION:-v0.5.0}"
export KNATIVE_EVENTING_VERSION="${KNATIVE_EVENTING_VERSION:-v0.5.0}"
